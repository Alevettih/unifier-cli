...
@NgModule({
  declarations: [ImagePlaceholderDirective, ClickOutsideDirective, ShowForRolesDirective, DndFileDirective],
  exports: [ImagePlaceholderDirective, ClickOutsideDirective, ShowForRolesDirective, DndFileDirective],
